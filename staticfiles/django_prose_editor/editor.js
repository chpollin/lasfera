var DjangoProseEditor = (() => {
  ...
  var Lr = (n, e, t) =>
      e in n
        ? zt(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
        : (n[e] = t),
    Cn = (n, e) => {
      for (var t in e || (e = {})) Jr.call(e, t) && Lr(n, t, e[t]);
      if (Vr) for (var t of Vr(e)) Ls.call(e, t) && Lr(n, t, e[t]);
      return n;
    };
  var Js = (n, e) => {
      for (var t in e) zt(n, t, { get: e[t], enumerable: !0 });
    },
    Ws = (n, e, t, r) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let i of Vs(e))
          !Jr.call(n, i) &&
            ...
            zt(n, i, {
              get: () => e[i],
              enumerable: !(r = Fs(e, i)) || r.enumerable,
            });
      return n;
    };
  var qs = (n) => Ws(zt({}, "__esModule", { value: !0 }), n);
  var jf = {};
  Js(jf, { createEditor: () => zs });
  function v(n) {
    this.content = n;
  }
  v.prototype = {
    ...
    update: function (n, e, t) {
      var r = t && t != n ? this.remove(t) : this,
        ...
        o = r.content.slice();
      return (
        i == -1 ? o.push(t || n, e) : ((o[i + 1] = e), t && (o[i] = t)),
        new v(o)
      );
    },
    remove: function (n) {
  ...
  function _r(n, e, t) {
    for (let r = 0; ; r++) {
      ...
      if (i.content.size || o.content.size) {
        let s = _r(i.content, o.content, t + 1);
        if (s != null) return s;
      }
      t += i.nodeSize;
    }
  ...
  function Ur(n, e, t, r) {
    for (let i = n.childCount, o = e.childCount; ; ) {
      ...
      if (s.content.size || l.content.size) {
        let c = Ur(s.content, l.content, t - 1, r - 1);
        if (c) return c;
      }
      (t -= a), (r -= a);
    }
  ...
  var y = class n {
    ...
    findIndex(e, t = -1) {
      if (e == 0) return Bt(0, e);
      if (e == this.size) return Bt(this.content.length, e);
      if (e > this.size || e < 0)
        throw new RangeError(`Position ${e} outside of fragment (${this})`);
      for (let r = 0, i = 0; ; r++) {
        let o = this.child(r),
          s = i + o.nodeSize;
        if (s >= e) return s == e || t > 0 ? Bt(r + 1, s) : Bt(r, i);
        i = s;
      }
    }
    toString() {
  ...
  function Ft(n, e) {
    ...
    if (t) {
      ...
      for (let r = 0; r < n.length; r++) if (!Ft(n[r], e[r])) return !1;
    } else {
      for (let r in n) if (!(r in e) || !Ft(n[r], e[r])) return !1;
  ...
  var O = class n {
    ...
    eq(e) {
      return this == e || (this.type == e.type && Ft(this.attrs, e.attrs));
    }
    toJSON() {
  ...
  var Ae = class extends Error {},
    b = class n {
      ...
      insertAt(e, t) {
        let r = Yr(this.content, e + this.openStart, t);
        return r && new n(r, this.openStart, this.openEnd);
      }
      removeBetween(e, t) {
        return new n(
          Gr(this.content, e + this.openStart, t + this.openStart),
          this.openStart,
          this.openEnd,
        );
      }
      ...
      static fromJSON(e, t) {
        ...
        return new n(y.fromJSON(e, t.content), r, i);
      }
  ...
  function Gr(n, e, t) {
    ...
    return n.replaceChild(r, o.copy(Gr(o.content, e - i - 1, t - i - 1)));
  }
  function Yr(n, e, t, r) {
    ...
    let l = Yr(s.content, e - o - 1, t);
    return l && n.replaceChild(i, s.copy(l));
  }
  function Ks(n, e, t) {
    if (t.openStart > n.depth)
      throw new Ae("Inserted content deeper than insertion position");
    if (n.depth - t.openStart != e.depth - t.openEnd)
      throw new Ae("Inconsistent open depths");
    return Xr(n, e, t, 0);
  }
  function Xr(n, e, t, r) {
    let i = n.index(r),
    ...
    if (i == e.index(r) && r < n.depth - t.openStart) {
      ...
      if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
        ...
        let { start: s, end: l } = $s(t, n);
        return Ee(o, Zr(n, s, l, e, r));
      }
    else return Ee(o, Vt(n, e, r));
  }
  function Qr(n, e) {
    if (!e.type.compatibleContent(n.type))
      throw new Ae("Cannot join " + e.type.name + " onto " + n.type.name);
  }
  function En(n, e, t) {
    let r = n.node(t);
  ...
  function lt(n, e, t, r) {
    ...
    n &&
      ((o = n.index(t)),
      n.depth > t ? o++ : n.textOffset && (De(n.nodeAfter, r), o++));
  ...
  function Zr(n, e, t, r, i) {
    ...
    return (
      ...
      o && s && e.index(i) == t.index(i)
        ? (Qr(o, s), De(Ee(o, Zr(n, e, t, r, i + 1)), l))
        : (o && De(Ee(o, Vt(n, e, i + 1)), l),
          lt(e, t, i, l),
          s && De(Ee(s, Vt(t, r, i + 1)), l)),
      lt(r, null, i, l),
      new y(l)
    );
  }
  ...
  function $s(n, e) {
    ...
    for (let o = t - 1; o >= 0; o--) i = e.node(o).copy(y.from(i));
    return {
  ...
  var Lt = class n {
    ...
    re = class n {
      ...
      hasMarkup(e, t, r) {
        return (
          this.type == e &&
          Ft(this.attrs, t || e.defaultAttrs || js) &&
      ...
      mark(e) {
        return e == this.marks
          ? this
          : new n(this.type, this.attrs, this.content, e);
      }
      ...
      replace(e, t, r) {
        return Ks(this.resolve(e), this.resolve(t), r);
      }
      nodeAt(e) {
        for (let t = this; ; ) {
      ...
      resolve(e) {
        return Lt.resolveCached(this, e);
      }
      resolveNoCache(e) {
        return Lt.resolve(this, e);
      }
      rangeHasMark(e, t, r) {
        let i = !1;
        return (
      ...
      canReplace(e, t, r = y.empty, i = 0, o = r.childCount) {
  ...
  re.prototype.text = void 0;
  var An = class n extends re {
    constructor(e, t, r, i) {
    ...
    toString() {
      return this.type.spec.toDebugString
        ...
        : ei(this.marks, JSON.stringify(this.text));
    }
    get textContent() {
      return this.text;
    }
    ...
    fillBefore(e, t = !1, r = 0) {
      ...
      function o(s, l) {
        ...
        for (let c = 0; c < s.next.length; c++) {
          let { type: f, next: h } = s.next[c];
          if (!(f.isText || f.hasRequiredAttrs()) && i.indexOf(h) == -1) {
            i.push(h);
            let d = o(h, l.concat(f));
            if (d) return d;
          }
        }
        return null;
...
`)
  ...
  function oi(n) {
    let e = Object.create(null);
    if (n) for (let t in n) e[t] = new Rn(n[t]);
    return e;
  }
  var Jt = class n {
      constructor(e, t, r) {
        (this.name = e),
          ...
          (this.attrs = oi(r.attrs)),
          (this.defaultAttrs = ri(this.attrs)),
      ...
      create(e = null, t, r) {
        ...
        return new re(this, this.computeAttrs(e), y.from(t), O.setFrom(r));
      }
      createChecked(e = null, t, r) {
        return (
          (t = y.from(t)),
          this.checkContent(t),
          new re(this, this.computeAttrs(e), t, O.setFrom(r))
        );
      }
      createAndFill(e = null, t, r) {
        ...
        let i = this.contentMatch.matchFragment(t),
          o = i && i.fillBefore(y.empty, !0);
        return o ? new re(this, e, t.append(o), O.setFrom(r)) : null;
      }
      validContent(e) {
    ...
    ct = class n {
      constructor(e, t, r, i) {
        (this.name = e),
          ...
          (this.schema = r),
          (this.spec = i),
          (this.attrs = oi(i.attrs)),
          (this.excluded = null);
        let o = ri(this.attrs);
        this.instance = o ? new O(this, o) : null;
      }
      create(e = null) {
        return !e && this.instance
          ? this.instance
          : new O(this, ii(this.attrs, e));
      }
      static compile(e, t) {
        let r = Object.create(null),
          i = 0;
        return e.forEach((o, s) => (r[o] = new n(o, i++, t, s))), r;
      }
      removeFromSet(e) {
    ...
    ke = class {
      constructor(e) {
        ...
        (t.nodes = On.from(e.nodes)),
          (t.marks = On.from(e.marks || {})),
          (this.nodes = Jt.compile(this.spec.nodes, this)),
          (this.marks = ct.compile(this.spec.marks, this));
        let r = Object.create(null);
        for (let i in this.nodes) {
          ...
          let o = this.nodes[i],
            s = o.spec.content || "",
            l = o.spec.marks;
          (o.contentMatch = r[s] || (r[s] = Re.parse(s, this.nodes))),
      ...
      text(e, t) {
        ...
        return new An(r, r.defaultAttrs, e, O.setFrom(t));
      }
      mark(e, t) {
        return typeof e == "string" && (e = this.marks[e]), e.create(t);
      }
      nodeFromJSON(e) {
        return re.fromJSON(this, e);
      }
      markFromJSON(e) {
  ...
  var ve = class n {
      ...
      parse(e, t = {}) {
        let r = new Kt(this, t, !1);
        return r.addAll(e, t.from, t.to), r.finish();
      }
      parseSlice(e, t = {}) {
        let r = new Kt(this, t, !0);
        return r.addAll(e, t.from, t.to), b.maxOpen(r.finish());
      }
      matchTag(e, t, r) {
        for (
      ...
      static schemaRules(e) {
        ...
        for (let i in e.marks) {
          ...
          o &&
            o.forEach((s) => {
              r((s = Hr(s))), s.mark || s.ignore || s.clearMark || (s.mark = i);
            });
        }
        for (let i in e.nodes) {
          ...
          o &&
            o.forEach((s) => {
              r((s = Hr(s))), s.node || s.ignore || s.mark || (s.node = i);
            });
        }
        return t;
      }
      static fromSchema(e) {
        return (
          e.cached.domParser ||
          (e.cached.domParser = new n(e, n.schemaRules(e)))
        );
      }
    },
    si = {
  ...
  var je = class {
      constructor(e, t, r, i, o, s, l) {
        (this.type = e),
          ...
          (this.stashMarks = []),
          (this.match = s || (l & at ? null : e.contentMatch));
      }
      findWrapping(e) {
        if (!this.match) {
          if (!this.type) return [];
      ...
      finish(e) {
        ...
        return (
          !e &&
            this.match &&
            (t = t.append(this.match.fillBefore(y.empty, !0))),
      ...
      applyPending(e) {
        for (let t = 0, r = this.pendingMarks; t < r.length; t++) {
          let i = r[t];
          (this.type ? this.type.allowsMarkType(i.type) : ll(i.type, e)) &&
      ...
      inlineContext(e) {
        return this.type
          ...
          : e.parentNode &&
            !si.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
      }
    },
    Kt = class {
      constructor(e, t, r) {
        ...
        let i = t.topNode,
          o,
          s = $r(null, t.preserveWhitespace, 0) | (r ? at : 0);
        i
          ? (o = new je(
              i.type,
              i.attrs,
          ...
          : r
          ? (o = new je(null, null, O.none, O.none, !0, null, s))
          : (o = new je(
...
`,
      ...
      addElement(e, t) {
        let r = e.nodeName.toLowerCase(),
          i;
        li.hasOwnProperty(r) && this.parser.normalizeLists && il(e);
        let o =
          (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
          (i = this.parser.matchTag(e, this, t));
        if (o ? o.ignore : rl.hasOwnProperty(r))
...
`),
          ...
          for (let o = void 0; ; ) {
            ...
            if (
              (s.clearMark
                ...
                : (t = this.parser.schema.marks[s.mark]
                    .create(s.attrs)
                    .addToSet(t)),
              s.consuming === !1)
            )
      ...
      enterInner(e, t = null, r = !1, i) {
        ...
        let s = $r(e, i, o.options);
        o.options & at && o.content.length == 0 && (s |= at),
          this.nodes.push(
            new je(e, t, o.activeMarks, o.pendingMarks, r, null, s),
          ),
          this.open++;
      }
      closeExtra(e = !1) {
      ...
      addPendingMark(e) {
        let t = al(e, this.top.pendingMarks);
  ...
  var ie = class n {
        ...
        e.forEach((s) => {
          if (o.length || s.marks.length) {
            ...
            for (; a < s.marks.length; ) {
              let c = s.marks[a++],
                f = this.serializeMark(c, s.isInline, t);
              f &&
                (o.push([c, i]),
                i.appendChild(f.dom),
    ...
    serializeNodeInner(e, t) {
      let { dom: r, contentDOM: i } = n.renderSpec(
        Dn(t),
    ...
    static renderSpec(e, t, r = null) {
      ...
      if (
        ...
        for (let f in a)
          if (a[f] != null) {
            let h = f.indexOf(" ");
            h > 0
              ? l.setAttributeNS(f.slice(0, h), f.slice(h + 1), a[f])
      ...
      for (let f = c; f < t.length; f++) {
        ...
        if (h === 0) {
          ...
          let { dom: d, contentDOM: p } = n.renderSpec(e, h, r);
          if ((l.appendChild(d), p)) {
  ...
  var di = 1,
    ...
    dt = class {
      ...
      get deletedBefore() {
        return (this.delInfo & (di | $t)) > 0;
      }
      get deletedAfter() {
        return (this.delInfo & (ui | $t)) > 0;
      }
      get deletedAcross() {
        return (this.delInfo & $t) > 0;
      }
    },
    he = class n {
      constructor(e, t = !1) {
        ...
        for (let l = 0; l < this.ranges.length; l += 3) {
          ...
          if (e <= h) {
            let d = c ? (e == a ? -1 : e == h ? 1 : t) : t,
              p = a + i + (d < 0 ? 0 : f);
            if (r) return p;
            let u = e == (t < 0 ? a : h) ? null : cl(l / 3, e - a),
              m = e == a ? ui : e == h ? di : $t;
            return (t < 0 ? e != a : e != h) && (m |= pi), new dt(p, m, u);
          }
          i += f - c;
        }
        return r ? e + i : new dt(e + i, 0, null);
      }
      touches(e, t) {
        let r = 0,
          i = ai(t),
    ...
    A = class n {
      ...
      static fromReplace(e, t, r, i) {
        try {
          ...
          if (o instanceof Ae) return n.fail(o.message);
          throw o;
        }
      }
    };
  function Vn(n, e, t) {
    ...
    for (let i = 0; i < n.childCount; i++) {
      let o = n.child(i);
      o.content.size && (o = o.copy(Vn(o.content, e, o))),
  ...
  var pt = class n extends D {
    ...
    merge(e) {
      return e instanceof n &&
        ...
        this.from <= e.to &&
        this.to >= e.from
        ? new n(Math.min(this.from, e.from), Math.max(this.to, e.to), this.mark)
        : null;
    }
    toJSON() {
      return {
  ...
  var Pe = class n extends D {
    ...
    apply(e) {
      let t = e.slice(this.from, this.to),
        r = new b(
          Vn(t.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e),
          t.openStart,
          t.openEnd,
        );
  ...
  var mt = class n extends D {
    ...
    apply(e) {
      ...
      return A.fromReplace(
        e,
        this.pos,
        this.pos + 1,
        new b(y.from(r), 0, t.isLeaf ? 0 : 1),
      );
    }
    invert(e) {
      let t = e.nodeAt(this.pos);
      if (t) {
        ...
        if (r.length == t.marks.length) {
          for (let i = 0; i < t.marks.length; i++)
            if (!t.marks[i].isInSet(r)) return new n(this.pos, t.marks[i]);
  ...
  var K = class n extends D {
    ...
    apply(e) {
      return this.structure && Bn(e, this.from, this.to)
        ? A.fail("Structure replace would overwrite content")
        : A.fromReplace(e, this.from, this.to, this.slice);
    }
    getMap() {
  ...
  var E = class n extends D {
    ...
    apply(e) {
      if (
        this.structure &&
        (Bn(e, this.from, this.gapFrom) || Bn(e, this.gapTo, this.to))
      )
      ...
      return r
        ? A.fromReplace(e, this.from, this.to, r)
        : A.fail("Content does not fit in gap");
    }
    getMap() {
      return new he([
        this.from,
    ...
    map(e) {
      ...
      return (t.deletedAcross && r.deletedAcross) || i < t.pos || o > r.pos
        ? null
        : new n(t.pos, r.pos, i, o, this.slice, this.insert, this.structure);
    }
    toJSON() {
      let e = {
    ...
    n.doc.nodesBetween(e, t, (a, c, f) => {
      ...
      if (!r.isInSet(h) && f.type.allowsMarkType(r.type)) {
        ...
        for (let m = 0; m < h.length; m++)
          h[m].isInSet(u) ||
            (s && s.to == d && s.mark.eq(h[m])
              ? (s.to = p)
              : i.push((s = new Pe(d, p, h[m]))));
        l && l.to == d ? (l.to = p) : o.push((l = new pt(d, p, r)));
      }
    }),
      ...
      if (a && a.length) {
        ...
        for (let f = 0; f < a.length; f++) {
          ...
          for (let p = 0; p < i.length; p++) {
            let u = i[p];
            u.step == o - 1 && h.eq(i[p].style) && (d = u);
          }
          d
            ? ((d.to = c), (d.step = o))
            : i.push({ style: h, from: Math.max(l, e), to: c, step: o });
        }
      }
    }),
      i.forEach((s) => n.step(new Pe(s.from, s.to, s.style)));
  }
  function ul(n, e, t, r = t.contentMatch) {
    ...
    for (let l = 0; l < i.childCount; l++) {
      let a = i.child(l),
        c = s + a.nodeSize,
        f = r.matchType(a.type);
      if (!f) o.push(new K(s, c, b.empty));
      else {
        r = f;
        for (let h = 0; h < a.marks.length; h++)
          t.allowsMarkType(a.marks[h].type) || n.step(new Pe(s, c, a.marks[h]));
        if (a.isText && !t.spec.code) {
          ...
          for (; (h = d.exec(a.text)); )
            p ||
              (p = new b(
                y.from(t.schema.text(" ", t.allowedMarks(a.marks))),
                0,
                0,
              )),
              o.push(new K(s + h.index, s + h.index + h[0].length, p));
        }
      }
      s = c;
    }
  ...
  function Ue(n) {
    ...
    for (let r = n.depth; ; --r) {
      ...
      if (r == 0 || i.type.spec.isolating || !pl(i, o, s)) break;
    }
    return null;
  }
  function ml(n, e, t) {
    let { $from: r, $to: i, depth: o } = e,
      ...
      f = y.empty,
      h = 0;
    for (let u = o, m = !1; u > t; u--)
      m || r.index(u) > 0
        ? ((m = !0), (f = y.from(r.node(u).copy(f))), h++)
        : a--;
    let d = y.empty,
      p = 0;
    for (let u = o, m = !1; u > t; u--)
      m || i.after(u + 1) < i.end(u)
        ? ((m = !0), (d = y.from(i.node(u).copy(d))), p++)
        : c++;
    n.step(new E(a, c, s, l, new b(f.append(d), h, p), f.size - h, !0));
  }
  function Ut(n, e, t = null, r = n) {
    let i = gl(n, e),
      o = i && yl(r, e);
  ...
  function kl(n, e, t, r, i) {
    ...
    n.doc.nodesBetween(e, t, (s, l) => {
      if (
        s.isTextblock &&
        !s.hasMarkup(r, i) &&
        xl(n.doc, n.mapping.slice(o).map(l), r)
      ) {
        ...
        return (
          n.step(
            new E(
              ...
              c + 1,
              f - 1,
              new b(y.from(r.create(i, null, s.marks)), 0, 0),
              1,
              !0,
            ),
          ),
  ...
  function xe(n, e, t = 1, r) {
    ...
    for (let c = i.depth - 1, f = t - 2; c > o; c--, f--) {
      ...
      let p = h.content.cutByIndex(d, h.childCount),
        u = r && r[f + 1];
  ...
  function Ml(n, e, t = 1, r) {
    ...
    for (let l = i.depth, a = i.depth - t, c = t - 1; l > a; l--, c--) {
      ...
      let f = r && r[c];
      s = y.from(f ? f.type.create(f.attrs, s) : i.node(l).copy(s));
    }
    n.step(new K(e, e, new b(o.append(s), t, t), !0));
  }
  function yt(n, e) {
    let t = n.resolve(e),
      r = t.index();
  ...
  function Yt(n, e, t = e, r = b.empty) {
    if (e == t && !r.size) return null;
    let i = n.resolve(e),
      o = n.resolve(t);
    return mi(i, o, r) ? new K(e, t, r) : new Fn(i, o, r).fit();
  }
  function mi(n, e, t) {
    return (
      !t.openStart &&
  ...
  var Fn = class {
    ...
    fit() {
      ...
      let a = new b(o, s, l);
      return e > -1
        ? new E(r.pos, e, this.$to.pos, this.$to.end(), a, t)
      ...
      for (let t = 1; t <= 2; t++)
        for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
          let i,
            o = null;
          r
            ? ((o = Pn(this.unplaced.content, r - 1).firstChild),
              (i = o.content))
          ...
          for (let l = this.depth; l >= 0; l--) {
            ...
            if (
              t == 1 &&
              (s
                ? c.matchType(s.type) || (h = c.fillBefore(y.from(s), !1))
    ...
    dropNode() {
      ...
      if (i.childCount <= 1 && t > 0) {
        ...
        this.unplaced = new b(ft(e, t - 1, 1), t - 1, o ? t - 1 : r);
      } else this.unplaced = new b(ft(e, t, 1), t, r);
    }
    placeNodes({
      sliceDepth: e,
      frontierDepth: t,
      ...
      u || (p = -1),
        (this.placed = ht(this.placed, t, y.from(f))),
      ...
      this.unplaced = u
        ? e == 0
          ? b.empty
          : new b(ft(s.content, e - 1, 1), e - 1, p < 0 ? s.openEnd : e - 1)
        : new b(ft(s.content, e, c), s.openStart, s.openEnd);
    }
    mustMoveInline() {
      ...
      if (
        !e.type.isTextblock ||
        !zn(this.$to, this.$to.depth, e.type, e.match, !1) ||
    ...
    close(e) {
      ...
      t.fit.childCount && (this.placed = ht(this.placed, t.depth, t.fit)),
        (e = t.move);
    ...
    openFrontierNode(e, t = null, r) {
      ...
      (i.match = i.match.matchType(e)),
        (this.placed = ht(this.placed, this.depth, y.from(e.create(t, r)))),
  ...
  function ft(n, e, t) {
    return e == 0
      ...
      : n.replaceChild(
          0,
          n.firstChild.copy(ft(n.firstChild.content, e - 1, t)),
        );
  }
  function ht(n, e, t) {
    return e == 0
      ...
      : n.replaceChild(
          n.childCount - 1,
          n.lastChild.copy(ht(n.lastChild.content, e - 1, t)),
        );
  }
  function Pn(n, e) {
  ...
  function gi(n, e, t) {
    ...
    return (
      e > 1 &&
        (r = r.replaceChild(
          0,
          gi(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0),
        )),
      e > 0 &&
  ...
  function zn(n, e, t, r, i) {
    ...
    return l && !Nl(t, o.content, s) ? l : null;
  }
  function Nl(n, e, t) {
  ...
  function Dl(n, e, t, r) {
    ...
    for (let d = i.depth, p = i.pos - 1; d > 0; d--, p--) {
      ...
      s.indexOf(d) > -1 ? (l = d) : i.before(d) == p && s.splice(1, 0, -d);
    }
    let a = s.indexOf(l),
      c = [],
      f = r.openStart;
    ...
    for (let d = r.openStart; d >= 0; d--) {
      ...
      if (u)
        for (let m = 0; m < s.length; m++) {
          ...
          let N = i.node(g - 1),
            ee = i.index(g - 1);
          if (N.canReplaceWith(ee, ee, u.type, u.marks))
            return n.replace(
              i.before(g),
              k ? o.after(g) : t,
              new b(yi(r.content, 0, r.openStart, p), p, r.openEnd),
            );
        }
    }
  ...
  function yi(n, e, t, r, i) {
    if (e < t) {
      let o = n.firstChild;
      n = n.replaceChild(0, o.copy(yi(o.content, e + 1, t, r, o)));
    }
    if (e > r) {
      let o = i.contentMatchAt(0),
        s = o.fillBefore(n).append(n);
      n = s.append(o.matchFragment(s).fillBefore(y.empty, !0));
    }
    return n;
  }
  function El(n, e, t, r) {
    if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
      let i = wl(n.doc, e, r.type);
      i != null && (e = t = i);
    }
    n.replaceRange(e, t, new b(y.from(r), 0, 0));
  }
  function Al(n, e, t) {
  ...
  _e.prototype.name = "TransformError";
  var _t = class {
    constructor(e) {
      (this.doc = e),
        (this.steps = []),
    ...
    step(e) {
      ...
      if (t.failed) throw new _e(t.failed);
      return this;
    }
    maybeStep(e) {
    ...
    replace(e, t = e, r = b.empty) {
      let i = Yt(this.doc, e, t, r);
      return i && this.step(i), this;
    }
    replaceWith(e, t, r) {
      return this.replace(e, t, new b(y.from(r), 0, 0));
    }
    delete(e, t) {
  ...
  var Ln = Object.create(null),
    S = class {
      constructor(e, t, r) {
        (this.$anchor = e),
          (this.$head = t),
          (this.ranges = r || [new Wn(e.min(t), e.max(t))]);
      }
      get anchor() {
      ...
      replace(e, t = b.empty) {
        ...
        for (let l = 0; l < s.length; l++) {
          ...
          e.replaceRange(f.map(a.pos), f.map(c.pos), l ? b.empty : t),
            l == 0 && Si(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
        }
      }
      replaceWith(e, t) {
        ...
        for (let o = 0; o < i.length; o++) {
          ...
          o
            ? e.deleteRange(c, f)
            : (e.replaceRangeWith(c, f, t), Si(e, r, t.isInline ? -1 : 1));
        }
      }
      static findFrom(e, t, r = !1) {
        let i = e.parent.inlineContent
          ? new w(e)
          : Ge(e.node(0), e.parent, e.pos, e.index(), t, r);
        if (i) return i;
      ...
      static atStart(e) {
        return Ge(e, e, 0, 0, 1) || new $(e);
      }
      static atEnd(e) {
        return Ge(e, e, e.content.size, e.childCount, -1) || new $(e);
      }
      static fromJSON(e, t) {
        if (!t || !t.type)
  ...
  var w = class n extends S {
    ...
    static between(e, t, r) {
      ...
      if (((!r || i) && (r = i >= 0 ? 1 : -1), !t.parent.inlineContent)) {
        let o = S.findFrom(t, r, !0) || S.findFrom(t, -r, !0);
        if (o) t = o.$head;
        else return S.near(t, r);
      }
      return (
        e.parent.inlineContent ||
          (i == 0
            ? (e = t)
            : ((e = (S.findFrom(e, -r, !0) || S.findFrom(e, r, !0)).$anchor),
              e.pos < t.pos != i < 0 && (e = t))),
        new n(e, t)
      );
    }
  ...
  function Si(n, e, t) {
    ...
    if (r < e) return;
    let i = n.steps[r];
    if (!(i instanceof K || i instanceof E)) return;
    let o = n.mapping.maps[r],
      s;
    o.forEach((l, a, c, f) => {
      s == null && (s = f);
    }),
      n.setSelection(S.near(n.doc.resolve(s), t));
  }
  var Mi = 1,
    Xt = 2,
    Ci = 4,
    Kn = class extends _t {
      ...
      setSelection(e) {
        ...
        return (
          (this.curSelection = e),
          (this.curSelectionFor = this.steps.length),
          (this.updated = (this.updated | Mi) & ~Xt),
      ...
      setStoredMarks(e) {
        return (this.storedMarks = e), (this.updated |= Xt), this;
      }
      ensureMarks(e) {
        return (
      ...
      get storedMarksSet() {
        return (this.updated & Xt) > 0;
      }
      addStep(e, t) {
        super.addStep(e, t),
          (this.updated = this.updated & ~Xt),
          (this.storedMarks = null);
      }
      setTime(e) {
          ...
          t &&
            (e = e.mark(
              this.storedMarks ||
                (r.empty
                  ? r.$from.marks()
                  : r.$from.marksAcross(r.$to) || O.none),
            )),
  ...
  var ze = class {
      constructor(e, t, r) {
        (this.name = e),
          (this.init = Oi(t.init, r)),
          (this.apply = Oi(t.apply, r));
      }
    },
    Rl = [
      new ze("doc", {
          ...
          t &&
            t.forEach((r) => {
              ...
              this.plugins.push(r),
                ...
                r.spec.state &&
                  this.fields.push(new ze(r.key, r.spec.state, r));
            });
      }
    },
    Zt = class n {
              ...
              if (f && r.filterTransaction(f, s)) {
                if ((f.setMeta("appendedTransaction", e), !i)) {
                  ...
                  for (let h = 0; h < this.config.plugins.length; h++)
                    i.push(
                      h < s ? { state: r, n: t.length } : { state: this, n: 0 },
                    );
                }
      ...
      static fromJSON(e, t, r) {
        ...
        return (
          i.fields.forEach((s) => {
            if (s.name == "doc") o.doc = re.fromJSON(e.schema, t.doc);
  ...
  var J = class {
      constructor(e) {
        (this.spec = e),
          (this.props = {}),
          e.props && wi(e.props, this, this.props),
          (this.key = e.key ? e.key.key : Ni("plugin"));
      }
      getState(e) {
        return e[this.key];
      }
    ...
    if (r.parent.content.size == 0 && (Ye(o, "end") || x.isSelectable(o))) {
      ...
      if (s && s.slice.size < s.to - s.from) {
        if (e) {
          ...
          l.setSelection(
            Ye(o, "end")
              ? S.findFrom(l.doc.resolve(l.mapping.map(i.pos, -1)), -1)
              : x.create(l.doc, i.pos - o.nodeSize),
          ),
            e(l.scrollIntoView());
        }
        return !0;
  ...
  var zl = (n, e, t) => {
    ...
    return !s || !x.isSelectable(s)
      ? !1
      : (e &&
          e(
            n.tr
              .setSelection(x.create(n.doc, o.pos - s.nodeSize))
              .scrollIntoView(),
          ),
        !0);
  };
  ...
  var Fl = (n, e, t) => {
      ...
      if (r.parent.content.size == 0 && (Ye(o, "start") || x.isSelectable(o))) {
        ...
        if (s && s.slice.size < s.to - s.from) {
          if (e) {
            ...
            l.setSelection(
              Ye(o, "start")
                ? S.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1)
                : x.create(l.doc, l.mapping.map(i.pos)),
            ),
              e(l.scrollIntoView());
          }
          return !0;
    ...
    Vl = (n, e, t) => {
      ...
      return !s || !x.isSelectable(s)
        ? !1
        : (e && e(n.tr.setSelection(x.create(n.doc, o.pos)).scrollIntoView()),
          !0);
    };
  function Ai(n) {
    if (!n.parent.type.spec.isolating)
...
`,
  ...
  var jn = (n, e) => {
    ...
    Jl = (n, e) => {
      let t = n.selection,
        { $from: r, $to: i } = t;
      if (t instanceof $ || r.parent.inlineContent || i.parent.inlineContent)
        return !1;
      let o = Hn(i.parent.contentMatchAt(i.indexAfter()));
      if (!o || !o.isTextblock) return !1;
      if (e) {
        let s = (!r.parentOffset && i.index() < i.parent.childCount ? r : i)
            .pos,
          l = n.tr.insert(s, o.createAndFill());
        l.setSelection(w.create(l.doc, s + 1)), e(l.scrollIntoView());
      }
      return !0;
    },
    Wl = (n, e) => {
  ...
  function ql(n) {
    return (e, t) => {
      ...
      if (e.selection instanceof x && e.selection.node.isBlock)
        return !r.parentOffset || !xe(e.doc, r.pos)
          ? !1
      ...
      if (t) {
        let o = i.parentOffset == i.parent.content.size,
          s = e.tr;
        (e.selection instanceof w || e.selection instanceof $) &&
          s.deleteSelection();
        let l =
            r.depth == 0
              ? null
              : Hn(r.node(-1).contentMatchAt(r.indexAfter(-1))),
          a = n && n(i.parent, o),
          c = a ? [a] : o && l ? [{ type: l }] : void 0,
          f = xe(s.doc, s.mapping.map(r.pos), 1, c);
        if (
          (!c &&
            !f &&
            xe(s.doc, s.mapping.map(r.pos), 1, l ? [{ type: l }] : void 0) &&
            (l && (c = [{ type: l }]), (f = !0)),
          f &&
          ...
          let h = s.mapping.map(r.before()),
            d = s.doc.resolve(h);
          l &&
            r.node(-1).canReplaceWith(d.index(), d.index() + 1, l) &&
  ...
  var Kl = ql();
  var $l = (n, e) => (e && e(n.tr.setSelection(new $(n.doc))), !0);
  function Hl(n, e, t) {
    let r = e.nodeBefore,
      i = e.nodeAfter,
      o = e.index();
    return !r || !i || !r.type.compatibleContent(i.type)
      ...
      : !e.parent.canReplace(o, o + 1) || !(i.isTextblock || yt(n.doc, e.pos))
      ? !1
      : (t &&
          t(
            n.tr
    ...
    if (
      ...
      if (t) {
        ...
        for (let m = o.length - 1; m >= 0; m--)
          d = y.from(o[m].create(null, d));
        d = y.from(r.copy(d));
        let p = n.tr.step(
            new E(e.pos - 1, h, e.pos, h, new b(d, 1, 0), o.length, !0),
          ),
          u = h + 2 * o.length;
        yt(p.doc, u) && p.join(u), t(p.scrollIntoView());
      }
      return !0;
    }
    let a = S.findFrom(e, 1),
      c = a && a.$from.blockRange(a.$to),
      f = c && Ue(c);
    if (f != null && f >= e.depth)
      return t && t(n.tr.lift(c, f).scrollIntoView()), !0;
    if (l && Ye(i, "start", !0) && Ye(r, "end")) {
      let h = r,
        d = [];
  ...
  function Ri(n) {
    return function (e, t) {
      ...
      return i.node(o).isTextblock
        ? (t &&
            t(
              e.tr.setSelection(w.create(e.doc, n < 0 ? i.start(o) : i.end(o))),
            ),
          !0)
        : !1;
    };
      ...
      if (r)
        if (o)
          ...
          for (let c = 0; !l && c < s.length; c++) {
            let { $from: f, $to: h } = s[c];
            l = t.doc.rangeHasMark(f.pos, h.pos, n);
          }
  ...
  var Un = class {
    ...
    dragover(e) {
      ...
      let t = this.editorView.posAtCoords({ left: e.clientX, top: e.clientY }),
        ...
        o = typeof i == "function" ? i(this.editorView, t, e) : i;
      if (t && !o) {
        let s = t.pos;
  ...
  var T;
  for (T = 65; T <= 90; T++)
    (ue[T] = String.fromCharCode(T + 32)), (nn[T] = String.fromCharCode(T));
  var T;
  for (tn in ue) nn.hasOwnProperty(tn) || (nn[tn] = ue[tn]);
  var tn;
  function Bi(n) {
    var e =
        (Yl && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey) ||
        (Xl && n.shiftKey && n.key && n.key.length == 1) ||
        n.key == "Unidentified",
      t =
        (!e && n.key) ||
        (n.shiftKey ? nn : ue)[n.keyCode] ||
        n.key ||
        "Unidentified";
    return (
      t == "Esc" && (t = "Escape"),
  ...
  function Zl(n) {
    ...
    for (let l = 0; l < e.length - 1; l++) {
      ...
      else if (/^mod$/i.test(a)) Ql ? (s = !0) : (i = !0);
  ...
  function Yn(n) {
    return new J({ props: { handleKeyDown: Xn(n) } });
  }
  function Xn(n) {
    let e = ea(n);
    return function (t, r) {
  ...
  var I = function (n) {
    ...
    nr = null,
    me = function (n, e, t) {
      let r = nr || (nr = document.createRange());
      return (
        r.setEnd(n, t == null ? n.nodeValue.length : t),
        r.setStart(n, e || 0),
        r
      );
    },
    ...
    qe = function (n, e, t, r) {
      return t && (Fi(n, e, t, r, -1) || Fi(n, e, t, r, 1));
    },
  ...
  var pn = function (n) {
    return (
      n.focusNode &&
      qe(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
    );
  };
  function Be(n, e) {
  ...
  var se = typeof navigator != "undefined" ? navigator : null,
  ...
  function Li(n, e, t) {
    ...
    for (let s = t || n.dom; s; s = Ot(s)) {
      ...
      let l = s,
        ...
        h = 0;
      if (
        (e.top < c.top + pe(r, "top")
          ? (h = -(c.top - e.top + pe(i, "top")))
          : e.bottom > c.bottom - pe(r, "bottom") &&
            (h =
              e.bottom - e.top > c.bottom - c.top
                ? e.top + pe(i, "top") - c.top
                : e.bottom - c.bottom + pe(i, "bottom")),
        e.left < c.left + pe(r, "left")
          ? (f = -(c.left - e.left + pe(i, "left")))
          : e.right > c.right - pe(r, "right") &&
            (f = e.right - c.right + pe(i, "right")),
        f || h)
      )
        if (a) o.defaultView.scrollBy(f, h);
        else {
          let d = l.scrollLeft,
            p = l.scrollTop;
  ...
  function ua(n) {
    ...
    return { refDOM: r, refTop: i, stack: bo(n.dom) };
  }
  function bo(n) {
    let e = [],
      t = n.ownerDocument;
  ...
  function xo(n, e) {
    ...
    for (let f = n.firstChild, h = 0; f; f = f.nextSibling, h++) {
      let d;
      if (f.nodeType == 1) d = f.getClientRects();
      else if (f.nodeType == 3) d = me(f).getClientRects();
      else continue;
        ...
        if (u.top <= s && u.bottom >= l) {
          ...
          if (m < r) {
            (t = f),
              ...
              f.nodeType == 1 &&
                m &&
                (o = h + (e.left >= (u.left + u.right) / 2 ? 1 : 0));
            continue;
          }
        } else
          u.top > e.top &&
        ...
        if (
          (l.node.isBlock &&
            ...
            a.left > r.left || a.top > r.top
              ? (i = l.posBefore)
              : (a.right < r.left || a.bottom < r.top) && (i = l.posAfter)),
  ...
  function xa(n, e) {
    ...
    if (F) for (let c = s; r && c; c = Ot(c)) c.draggable && (r = void 0);
    if (((s = ya(s, e)), r)) {
      if (
        X &&
        r.nodeType == 1 &&
  ...
  function Se(n, e) {
    ...
    return Array.prototype.find.call(t, Ji) || n.getBoundingClientRect();
  }
  var Sa = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
  function Mo(n, e, t) {
    let {
    ...
    if (r.nodeType == 3)
      if (
        s &&
        (Sa.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))
      ) {
        let a = Se(me(r, i, i), t);
        ...
        return (
          t < 0 && !i
            ...
            ? a--
            : c++,
          St(Se(me(r, a, c), f), f < 0)
        );
      }
    if (!n.state.doc.resolve(e - (o || 0)).parent.inlineContent) {
      if (o == null && i && (t < 0 || i == oe(r))) {
        let a = r.childNodes[i - 1];
        if (a.nodeType == 1) return Qn(a.getBoundingClientRect(), !1);
      }
      if (o == null && i < oe(r)) {
        let a = r.childNodes[i];
        if (a.nodeType == 1) return Qn(a.getBoundingClientRect(), !0);
      }
    ...
    if (o == null && i < oe(r)) {
      ...
      let c = a
        ? a.nodeType == 3
          ...
          : null
        : null;
      if (c) return St(Se(c, -1), !0);
    }
    return St(Se(r.nodeType == 3 ? me(r) : r, -t), t >= 0);
  }
  function St(n, e) {
    ...
    return Co(n, e, () => {
      ...
      for (let l = o.firstChild; l; l = l.nextSibling) {
        ...
        if (l.nodeType == 1) a = l.getClientRects();
          ...
          a = me(l, 0, l.nodeValue.length).getClientRects();
        else continue;
  ...
  function Oa(n, e, t) {
    ...
    let i = r.parentOffset,
      ...
      l = n.domSelection();
    return !Ca.test(r.parent.textContent) || !l.modify
      ? t == "left" || t == "backward"
        ? o
        : s
      : Co(n, e, () => {
          ...
          let p = r.depth ? n.docView.domAfterPos(r.before()) : n.dom,
            ...
            g =
              (u && !p.contains(u.nodeType == 1 ? u : u.parentNode)) ||
              (a == u && c == m);
          try {
            l.collapse(f, h),
              a && (a != f || c != h) && l.extend && l.extend(a, c);
          } catch (k) {}
  ...
  function wa(n, e, t) {
    return Wi == e && qi == t
      ...
      : ((Wi = e),
        (qi = t),
        (Ki = t == "up" || t == "down" ? Ma(n, e, t) : Oa(n, e, t)));
  }
  var _ = 0,
    $i = 1,
    Fe = 2,
    ...
    Ke = class {
      ...
      localPosFromDOM(e, t, r) {
        ...
        let i;
        if (e == this.dom && this.contentDOM) i = t > I(this.contentDOM);
        else if (
          this.contentDOM &&
      ...
      domFromPos(e, t) {
        ...
        if (t <= 0) {
          ...
          return o && t && s && !o.border && !o.domAtom
            ...
            : { node: this.contentDOM, offset: o ? I(o.dom) + 1 : 0 };
        } else {
          let o,
            s = !0;
          for (
          ...
          return o && s && !o.border && !o.domAtom
            ...
            : {
                ...
                offset: o ? I(o.dom) : this.contentDOM.childNodes.length,
              };
        }
      }
      parseRange(e, t, r = 0) {
      ...
      setSelection(e, t, r, i = !1) {
        ...
        for (let d = 0, p = 0; d < this.children.length; d++) {
          let u = this.children[d],
            m = p + u.size;
          if (o > p && s < m)
            return u.setSelection(e - p - u.border, t - p - u.border, r, i);
          p = m;
        }
...
`
              ...
              for (let u = d, m; u; u = u.parentNode) {
                if ((m = u.nextSibling)) {
                  m.nodeName == "BR" &&
                    (l = a = { node: m.parentNode, offset: I(m) + 1 });
                  break;
                }
                let g = u.pmViewDesc;
        ...
        if (
          !(i || (f && F)) &&
          qe(l.node, l.offset, c.anchorNode, c.anchorOffset) &&
          qe(a.node, a.offset, c.focusNode, c.focusOffset)
        )
          return;
        let h = !1;
        if ((c.extend || e == t) && !f) {
    ...
    nt = class n extends Ke {
      ...
      static create(e, t, r, i) {
        ...
        return (
          (!s || !s.dom) &&
            (s = ie.renderSpec(document, t.type.spec.toDOM(t, r))),
    ...
    we = class n extends Ke {
      ...
      static create(e, t, r, i, o, s) {
        ...
        if (t.isText) {
          ...
          f ||
            ({ dom: f, contentDOM: h } = ie.renderSpec(
              document,
              t.type.spec.toDOM(t),
            ));
        !h &&
        ...
        return (
          (f = No(f, r, t)),
          c
            ? (a = new lr(e, t, r, i, f, h || null, d, c, o, s + 1))
            : t.isText
            ? new on(e, t, r, i, f, d, o)
            : new n(e, t, r, i, f, h || null, d, o, s + 1)
        );
      }
      parseRule() {
      ...
      updateChildren(e, t) {
        ...
        Ea(
          ...
          (c, f, h) => {
            c.spec.marks
              ...
              : c.type.side >= 0 &&
                !h &&
                a.syncToMarks(
                  f == this.node.childCount ? O.none : this.node.child(f).marks,
                  r,
                  e,
                ),
              a.placeWidget(c, e, i);
          ...
          a.destroyRest(),
          (a.changed || this.dirty == Fe) &&
            (s && this.protectLocalComposition(e, s),
            Oo(this.contentDOM, this.children, e),
            tt && Aa(this.dom));
      }
      localCompositionInfo(e, t) {
        ...
        if (this.node.inlineContent) {
          let s = o.nodeValue,
            l = Ia(this.node.content, s, r - t, i - t);
      ...
      protectLocalComposition(e, { node: t, pos: r, text: i }) {
        ...
        e.input.compositionNodes.push(s),
          (this.children = hr(this.children, r, r + i.length, e, s));
      }
      update(e, t, r, i) {
  ...
  function Hi(n, e, t, r, i) {
    No(r, e, n);
    let o = new we(void 0, n, e, t, r, r, r, i, 0);
    return o.contentDOM && o.updateChildren(i, 0), o;
  }
  var on = class n extends we {
      constructor(e, t, r, i, o, s, l) {
      ...
      update(e, t, r, i) {
        return this.dirty == le ||
          (this.dirty != _ && !this.inParent()) ||
          !e.sameMarkup(this.node)
          ? !1
          : (this.updateOuterDeco(t),
            (this.dirty != _ || e.text != this.node.text) &&
      ...
      slice(e, t, r) {
        ...
        return new n(this.parent, i, this.outerDeco, this.innerDeco, o, o, r);
      }
      markDirty(e, t) {
        super.markDirty(e, t),
  ...
  function Oo(n, e, t) {
    ...
    for (let o = 0; o < e.length; o++) {
      ...
      if (s instanceof nt) {
        ...
        Oo(s.contentDOM, s.children, t), (r = a ? a.nextSibling : n.firstChild);
      }
    }
    for (; r; ) (r = ji(r)), (i = !0);
  ...
  var Ve = [new Mt()];
  function ar(n, e, t) {
    if (n.length == 0) return Ve;
    let r = t ? Ve[0] : new Mt(),
      i = [r];
    for (let o = 0; o < n.length; o++) {
      let s = n[o].type.attrs;
      if (s) {
        s.nodeName && i.push((r = new Mt(s.nodeName)));
        for (let l in s) {
          let a = s[l];
          a != null &&
            (t &&
              i.length == 1 &&
              i.push((r = new Mt(e.isInline ? "span" : "div"))),
            l == "class"
  ...
  function No(n, e, t) {
    return wo(n, n, Ve, ar(e, t, n.nodeType != 1));
  }
  function cr(n, e) {
    if (n.length != e.length) return !1;
  ...
  var fr = class {
    constructor(e, t, r) {
      (this.lock = t),
        ...
        (this.changed = !1),
        (this.top = e),
        (this.preMatch = Ta(e.node.content, e));
    }
    destroyBetween(e, t) {
      if (e != t) {
    ...
    syncToMarks(e, t, r) {
      ...
      for (; o < e.length; ) {
        ...
        if (l > -1)
          ...
          let a = nt.create(this.top, e[o], t, r);
    ...
    updateNodeAt(e, t, r, i, o) {
      ...
      return (
        s.dirty == le && s.dom == s.contentDOM && (s.dirty = Fe),
        s.update(e, t, r, o)
        ...
        if (a instanceof we) {
          ...
          if (!d && a.update(e, t, r, i))
            return (
              ...
              a.dom != f && (this.changed = !0),
              this.index++,
              !0
            );
          if (!d && (h = this.recreateWrapper(a, e, t, r, i, s)))
            return (
              (this.top.children[this.index] = h),
              h.contentDOM &&
                ((h.dirty = Fe), h.updateChildren(i, s + 1), (h.dirty = _)),
              (this.changed = !0),
              this.index++,
              !0
            );
    ...
    recreateWrapper(e, t, r, i, o, s) {
      if (
        ...
        return null;
      let l = we.create(this.top, t, r, i, o, s);
      if (l.contentDOM) {
    ...
    addNode(e, t, r, i, o) {
      let s = we.create(this.top, e, t, r, i, o);
    ...
    e: for (; i > 0; ) {
      ...
      for (;;)
        if (r) {
          ...
          if (c instanceof nt) (t = c), (r = c.children.length);
          else {
            (l = c), r--;
            break;
          }
    ...
    for (let s = 0, l = 0; s < n.length; s++) {
      ...
      c >= t || f <= e
        ...
        : (c < e && o.push(a.slice(0, e - c, r)),
          i && (o.push(i), (i = void 0)),
          f > t && o.push(a.slice(t - c, a.size, r)));
    }
    return o;
  }
  function Mr(n, e = null) {
    ...
    if (pn(t)) {
      ...
      if (
        ...
        x.isSelectable(f) &&
        i.parent &&
        !(f.isInline && oa(t.focusNode, t.focusOffset, i.dom))
      ) {
        let h = i.posBefore;
    ...
    if ((Do(n, t), !!To(n))) {
      if (!e && n.input.mouseDown && n.input.mouseDown.allowDefault && B) {
        ...
        if (
          r.anchorNode &&
          i.anchorNode &&
          qe(r.anchorNode, r.anchorOffset, i.anchorNode, i.anchorOffset)
        ) {
      ...
      if ((n.domObserver.disconnectSelection(), n.cursorWrapper)) va(n);
        ...
        _i &&
          !(t instanceof w) &&
          (t.$from.parent.inlineContent || (o = Ui(n, t.from)),
          !t.empty && !t.$from.parent.inlineContent && (s = Ui(n, t.to))),
          ...
          t.visible
            ...
            : (n.dom.classList.add("ProseMirror-hideselection"),
              "onselectionchange" in document && Ra(n));
      }
  ...
  function Ui(n, e) {
    ...
    if (F && i && i.contentEditable == "false") return Zn(i);
    if (
  ...
  function Zn(n) {
    return (
      ...
      F && n.draggable && ((n.draggable = !1), (n.wasDraggable = !0)),
      n
    );
  }
  function Gi(n) {
    ...
    e.addEventListener(
      ...
      (n.input.hideSelectionGuard = () => {
        (t.anchorNode != r || t.anchorOffset != i) &&
          (e.removeEventListener("selectionchange", n.input.hideSelectionGuard),
          setTimeout(() => {
            (!To(n) || n.state.selection.visible) &&
              n.dom.classList.remove("ProseMirror-hideselection");
          }, 20));
      }),
    );
  ...
  function va(n) {
    let e = n.domSelection(),
      ...
      i = r.nodeName == "IMG";
    i ? t.setEnd(r.parentNode, I(r) + 1) : t.setEnd(r, 0),
      t.collapse(!1),
      e.removeAllRanges(),
      e.addRange(t),
      !i &&
  ...
  function Do(n, e) {
    if (e instanceof x) {
      ...
      t != n.lastSelectedViewDesc &&
        (Yi(n), t && t.selectNode(), (n.lastSelectedViewDesc = t));
    } else Yi(n);
  }
  function Yi(n) {
  ...
  function Qi(n, e, t) {
    ...
    if (r instanceof w)
        ...
        if (n.endOfTextblock(e > 0 ? "forward" : "backward")) {
          ...
          return o.isAtom || ((s = n.docView.descAt(l)) && !s.contentDOM)
            ? x.isSelectable(o)
              ? Me(
                  n,
                  new x(e < 0 ? n.state.doc.resolve(i.pos - o.nodeSize) : i),
                )
              : Et
              ? Me(n, new w(n.state.doc.resolve(e < 0 ? l : l + o.nodeSize)))
              : !1
            : !1;
        }
      } else return !1;
      ...
      if (r instanceof x && r.node.isInline)
        return Me(n, new w(e > 0 ? r.$to : r.$from));
      {
        let i = dr(n.state, e);
        return i ? Me(n, i) : !1;
      }
  ...
  function za(n) {
    ...
    let i,
      ...
      s = !1;
    for (
      X && t.nodeType == 1 && r < ln(t) && Ct(t.childNodes[r], -1) && (s = !0);
      ;
      ...
      if (r > 0) {
        ...
        if (Ao(t)) break;
        {
          ...
          for (; l && Ct(l, -1); )
            (i = t.parentNode), (o = I(l)), (l = l.previousSibling);
          if (l) (t = l), (r = ln(t));
          else {
    ...
    for (;;)
      if (r < i) {
        ...
        if (Ao(t)) break;
        {
          let l = t.nextSibling;
          for (; l && Ct(l, 1); )
            (o = l.parentNode), (s = I(l) + 1), (l = l.nextSibling);
          if (l) (t = l), (r = 0), (i = ln(t));
          else {
            if (((t = t.parentNode), t == n.dom)) break;
            r = i = 0;
  ...
  function Fa(n, e) {
    for (; n && e == n.childNodes.length && !Dt(n); )
      (e = I(n) + 1), (n = n.parentNode);
  ...
  function ur(n, e, t) {
    if (e.nodeType != 3) {
      ...
      (s = Fa(e, t))
        ? ((e = s), (t = 0))
        : (o = Va(e, t)) && ((e = o), (t = o.nodeValue.length));
    }
  ...
  function Zi(n, e) {
    ...
    if (!(B || ca) && t.parent.inlineContent) {
  ...
  function to(n, e) {
    if (!(n.state.selection instanceof w)) return !0;
  ...
  function La(n) {
    if (!F || n.state.selection.$head.parentOffset > 0) return !1;
  ...
  function Wa(n, e) {
    ...
    if ((t == 46 && !e.shiftKey) || (j && t == 68 && r == "c"))
      return to(n, 1) || Qe(n, 1);
    ...
    if (t == 37 || (j && t == 66 && r == "c")) {
      ...
      if (t == 38 || (j && t == 80 && r == "c"))
        return eo(n, -1, r) || Qe(n, -1);
      if (t == 40 || (j && t == 78 && r == "c"))
        return La(n) || eo(n, 1, r) || Qe(n, 1);
      if (r == (j ? "m" : "c") && (t == 66 || t == 73 || t == 89 || t == 90))
        return !0;
    }
    return !1;
  }
  function Io(n, e) {
    ...
    let s = n.someProp("clipboardSerializer") || ie.fromSchema(n.state.schema),
      l = Fo(),
    ...
    let c = a.firstChild,
      f,
      h = 0;
    for (; c && c.nodeType == 1 && (f = Bo[c.nodeName.toLowerCase()]); ) {
      for (let p = f.length - 1; p >= 0; p--) {
        let u = l.createElement(f[p]);
...
`,
    ...
    if (
      ...
      l = ja(ro(l, +f[1], +f[2]), f[4]);
    else if (
      ((l = b.maxOpen(Ka(l.content, i), !0)), l.openStart || l.openEnd)
    ) {
      let h = 0,
        d = 0;
      for (
        let p = l.content.firstChild;
        h < l.openStart && !p.type.spec.isolating;
        h++, p = p.firstChild
      );
      for (
        let p = l.content.lastChild;
        d < l.openEnd && !p.type.spec.isolating;
        d++, p = p.lastChild
      );
      l = ro(l, h, d);
    }
      ...
      if (
        (n.forEach((l) => {
          ...
          let a = i.findWrapping(l.type),
            c;
          if (!a) return (s = null);
          if ((c = s.length && o.length && Po(a, o, l, s[s.length - 1], 0)))
            s[s.length - 1] = c;
          else {
  ...
  function Po(n, e, t, r, i) {
    if (i < n.length && i < e.length && n[i] == e[i]) {
      ...
      if (
        ...
        return r.copy(r.content.append(y.from(vo(t, n, i + 1))));
    }
  }
  function zo(n, e) {
    if (e == 0) return n;
  ...
  function pr(n, e, t, r, i, o) {
    let s = e < 0 ? n.firstChild : n.lastChild,
      l = s.content;
    return (
      n.childCount > 1 && (o = 0),
      i < r - 1 && (l = pr(l, e, t, r, i + 1, o)),
      i >= t &&
        (l =
          e < 0
            ? s
                ...
                .fillBefore(l, o <= i)
                .append(l)
            : l.append(s.contentMatchAt(s.childCount).fillBefore(y.empty, !0))),
  ...
  function ro(n, e, t) {
    return (
      e < n.openStart &&
        (n = new b(
          pr(n.content, -1, e, n.openStart, 0, n.openEnd),
          e,
          n.openEnd,
        )),
      t < n.openEnd &&
        (n = new b(pr(n.content, 1, t, n.openEnd, 0, 0), n.openStart, t)),
      n
    );
  }
  var Bo = {
    ...
    io = null;
  function Fo() {
    return io || (io = document.implementation.createHTMLDocument("title"));
  }
  function $a(n) {
    let e = /^(\s*<meta [^>]*>)*/.exec(n);
    e && (n = n.slice(e[0].length));
    let t = Fo().createElement("div"),
      r = /<([a-z][^>\s]+)/i.exec(n),
      i;
    if (
      ((i = r && Bo[r[1].toLowerCase()]) &&
        (n =
          i.map((o) => "<" + o + ">").join("") +
          n +
          i
  ...
  function Ha(n) {
    let e = n.querySelectorAll(
      B ? "span:not([class]):not([style])" : "span.Apple-converted-space",
    );
    for (let t = 0; t < e.length; t++) {
      let r = e[t];
    ...
    for (let e in V) {
      ...
      n.dom.addEventListener(
        ...
        (n.input.eventHandlers[e] = (r) => {
          Ya(n, r) && !Or(n, r) && (n.editable || !(r.type in L)) && t(n, r);
        }),
        _a[e] ? { passive: !0 } : void 0,
      );
    }
    F && n.dom.addEventListener("input", () => null), gr(n);
  }
  function Ce(n, e) {
    ...
    n.someProp("handleDOMEvents", (e) => {
      for (let t in e)
        n.input.eventHandlers[t] ||
          n.dom.addEventListener(
            t,
            (n.input.eventHandlers[t] = (r) => Or(n, r)),
          );
    });
  }
  function Or(n, e) {
  ...
  L.keydown = (n, e) => {
    ...
    if (
      ...
      if (
        ...
        tt && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey)
      ) {
        let r = Date.now();
        (n.input.lastIOSEnter = r),
          (n.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
            n.input.lastIOSEnter == r &&
              (n.someProp("handleKeyDown", (i) => i(n, Be(13, "Enter"))),
              (n.input.lastIOSEnter = 0));
          }, 200));
      } else
        n.someProp("handleKeyDown", (r) => r(n, t)) || Wa(n, t)
          ? t.preventDefault()
          : Ce(n, "key");
  };
  L.keyup = (n, e) => {
  ...
  L.keypress = (n, e) => {
    let t = e;
    if (Lo(n, t) || !t.charCode || (t.ctrlKey && !t.altKey) || (j && t.metaKey))
      return;
  ...
  function Za(n, e) {
    ...
    let t = n.state.doc.resolve(e),
      r = t.nodeAfter;
    return r && r.isAtom && x.isSelectable(r)
      ? (et(n, new x(t), "pointer"), !0)
      : !1;
  }
  function ec(n, e) {
    if (e == -1) return !1;
  ...
  function nc(n, e, t, r) {
    return (
      wr(n, "handleDoubleClickOn", e, t, r) ||
      n.someProp("handleDoubleClick", (i) => i(n, e, r))
    );
  }
  function rc(n, e, t, r) {
    return (
      wr(n, "handleTripleClickOn", e, t, r) ||
  ...
  function ic(n, e, t) {
    ...
    if (e == -1)
      return r.inlineContent
        ? (et(n, w.create(r, 0, r.content.size), "pointer"), !0)
        : !1;
    let i = r.resolve(e);
    for (let o = i.depth + 1; o > 0; o--) {
      let s = o > i.depth ? i.nodeAfter : i.node(o),
        l = i.before(o);
      if (s.inlineContent)
        et(n, w.create(r, l + 1, l + 1 + s.content.size), "pointer");
    ...
    s &&
      (o == "singleClick"
        ? (n.input.mouseDown && n.input.mouseDown.done(),
          (n.input.mouseDown = new yr(n, s, t, !!r)))
        : (o == "doubleClick" ? nc : rc)(n, s.pos, s.inside, t)
        ? t.preventDefault()
        : Ce(n, "pointer"));
  };
  var yr = class {
    constructor(e, t, r, i) {
      ...
      ((r.button == 0 &&
        ...
        (c instanceof x && c.from <= s && c.to > s)) &&
        (this.mightDrag = {
          node: o,
          pos: s,
    ...
    up(e) {
      ...
      this.view.state.doc != this.startDoc &&
        (t = this.view.posAtCoords(mn(e))),
        this.updateAllowDefault(e),
        this.allowDefault || !t
          ? Ce(this.view, "pointer")
          : tc(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
            (this.flushed ||
          ...
          ? (et(
              this.view,
              S.near(this.view.state.doc.resolve(t.pos)),
              "pointer",
            ),
            e.preventDefault())
          : Ce(this.view, "pointer");
  ...
  V.touchstart = (n) => {
    (n.input.lastTouch = Date.now()), Nr(n), Ce(n, "pointer");
  };
  V.touchmove = (n) => {
  ...
  function Lo(n, e) {
    return n.composing
      ? !0
      : F && Math.abs(e.timeStamp - n.input.compositionEndedAt) < 500
  ...
  function Jo(n, e) {
    clearTimeout(n.input.composingTimeout),
      e > -1 && (n.input.composingTimeout = setTimeout(() => an(n), e));
  }
  function Wo(n) {
    for (
      n.composing &&
      ((n.input.composing = !1), (n.input.compositionEndedAt = lc()));
  ...
  function sc(n) {
    ...
    let t = ra(e.focusNode, e.focusOffset),
      r = ia(e.focusNode, e.focusOffset);
    if (t && r && t != r) {
      let i = r.pmViewDesc;
  ...
  function an(n, e = !1) {
    if (!(Y && n.domObserver.flushingSoon >= 0)) {
      if (
        (n.domObserver.forceFlush(), Wo(n), e || (n.docView && n.docView.dirty))
      ) {
        let t = Mr(n);
        return (
  ...
  var wt = (W && Oe < 15) || (tt && fa < 604);
  V.copy = L.cut = (n, e) => {
    let t = e,
      r = n.state.selection,
      i = t.type == "cut";
    if (r.empty) return;
    let o = wt ? null : t.clipboardData,
      s = r.content(),
      { dom: l, text: a } = Io(n, s);
    o
      ? (t.preventDefault(),
  ...
  function fc(n, e) {
    ...
    setTimeout(() => {
      n.focus(),
        ...
        t
          ? Nt(n, r.value, null, i, e)
          : Nt(n, r.textContent, r.innerHTML, i, e);
    }, 50);
  }
  ...
  L.paste = (n, e) => {
    ...
    r && Nt(n, qo(r), r.getData("text/html"), i, t)
      ? t.preventDefault()
      : fc(n, t);
  };
  var cn = class {
  ...
  V.dragstart = (n, e) => {
    ...
    let i = n.state.selection,
      ...
      s;
    if (
      !(o && o.pos >= i.from && o.pos <= (i instanceof x ? i.to - 1 : i.to))
    ) {
      if (r && r.mightDrag) s = x.create(n.state.doc, r.mightDrag.pos);
        ...
        f &&
          ...
          f != n.docView &&
          (s = x.create(n.state.doc, f.posBefore));
      }
    }
    let l = (s || n.state.selection).content(),
      { dom: a, text: c } = Io(n, l);
    t.dataTransfer.clearData(),
      t.dataTransfer.setData(wt ? "Text" : "text/html", a.innerHTML),
      (t.dataTransfer.effectAllowed = "copyMove"),
      wt || t.dataTransfer.setData("text/plain", c),
      (n.dragging = new cn(l, !t[Ko], s));
  };
  V.dragend = (n) => {
    let e = n.dragging;
    window.setTimeout(() => {
  ...
  L.dragover = L.dragenter = (n, e) => e.preventDefault();
  L.drop = (n, e) => {
    let t = e,
      r = n.dragging;
    ...
    s
      ...
      : (s = Ro(
          n,
          qo(t.dataTransfer),
          wt ? null : t.dataTransfer.getData("text/html"),
          !1,
          o,
        ));
    let l = !!(r && !t[Ko]);
    ...
    if (!s) return;
    t.preventDefault();
    let a = s ? Gt(n.state.doc, o.pos, s) : o.pos;
    a == null && (a = o.pos);
    let c = n.state.tr;
    if (l) {
      let { node: u } = r;
    ...
    if (
      (h
        ? c.replaceRangeWith(f, f, s.content.firstChild)
        : c.replaceRange(f, f, s),
      c.doc.eq(d))
    )
      return;
    ...
    if (
      h &&
      x.isSelectable(s.content.firstChild) &&
      p.nodeAfter &&
      ...
      c.mapping.maps[c.mapping.maps.length - 1].forEach(
        ...
        c.setSelection(Cr(n, p, c.doc.resolve(u)));
    }
    ...
    if (B && Y && e.inputType == "deleteContentBackward") {
      ...
      setTimeout(() => {
        if (
          ...
          (n.dom.blur(),
          n.focus(),
          n.someProp("handleKeyDown", (o) => o(n, Be(8, "Backspace"))))
        )
          return;
  ...
  var fn = class n {
        ...
        return (
          ...
          (e instanceof n &&
            ((this.spec.key && this.spec.key == e.spec.key) ||
              (this.toDOM == e.toDOM && Tt(this.spec, e.spec))))
        );
      }
      destroy(e) {
    ...
    Le = class n {
      ...
      eq(e) {
        return (
          this == e ||
          (e instanceof n && Tt(this.attrs, e.attrs) && Tt(this.spec, e.spec))
        );
      }
      static is(e) {
    ...
    br = class n {
      ...
      map(e, t, r, i) {
        ...
        return s.deleted || s.pos <= o.pos
          ? null
          : new ae(o.pos - r, s.pos - r, this);
      }
      valid(e, t) {
        let { index: r, offset: i } = e.content.findIndex(t.from),
          o;
        return (
          i == t.from && !(o = e.child(r)).isText && i + o.nodeSize == t.to
        );
      }
      eq(e) {
        return (
    ...
    ae = class n {
      ...
      static widget(e, t, r) {
        return new n(e, e, new fn(t, r));
      }
      static inline(e, t, r, i) {
        return new n(e, t, new Le(r, i));
      }
      static node(e, t, r, i) {
        return new n(e, t, new br(r, i));
      }
      get spec() {
    ...
    q = class n {
      constructor(e, t) {
        (this.local = e.length ? e : Ze), (this.children = t.length ? t : Ze);
      }
      static create(e, t) {
        return t.length ? dn(t, e, 0, Je) : P;
      }
      find(e, t, r) {
        let i = [];
        return (
          this.findInner(e == null ? 0 : e, t == null ? 1e9 : t, i, 0, r), i
        );
      }
      findInner(e, t, r, i, o) {
      ...
      map(e, t, r) {
        return this == P || e.maps.length == 0
          ? this
          : this.mapInner(e, t, 0, 0, r || Je);
      }
      mapInner(e, t, r, i, o) {
        let s;
      ...
      addInner(e, t, r) {
        ...
        e.forEach((l, a) => {
          ...
          if ((f = Ho(t, l, c))) {
            for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
              o += 3;
            i[o] == a
              ? (i[o + 2] = i[o + 2].addInner(l, f, c + 1))
              : i.splice(o, 0, a, a + l.nodeSize, dn(f, l, c + 1, Je)),
              (o += 3);
          }
        });
        let s = $o(o ? jo(t) : t, -r);
        ...
        return new n(
          s.length ? this.local.concat(s).sort(We) : this.local,
          i || this.children,
        );
      }
      remove(e) {
        return e.length == 0 || this == P ? this : this.removeInner(e, 0);
      }
      removeInner(e, t) {
        let r = this.children,
          i = this.local;
      ...
      forChild(e, t) {
        ...
        for (let l = 0; l < this.local.length; l++) {
          let a = this.local[l];
          if (a.from < s && a.to > o && a.type instanceof Le) {
  ...
  var P = q.empty,
    hn = class n {
      ...
      forChild(e, t) {
        if (t.isLeaf) return q.empty;
        let r = [];
        for (let i = 0; i < this.members.length; i++) {
          let o = this.members[i].forChild(e, t);
          o != P && (o instanceof n ? (r = r.concat(o.members)) : r.push(o));
        }
        return n.from(r);
      }
      eq(e) {
      ...
      static from(e) {
        switch (e.length) {
          ...
          default:
            return new n(
              e.every((t) => t instanceof q)
                ? e
                : e.reduce(
                    (t, r) => t.concat(r instanceof q ? r : r.members),
                    [],
                  ),
            );
        }
  ...
  function hc(n, e, t, r, i, o, s) {
    ...
    for (let c = 0; c < l.length; c += 3)
      if (l[c + 1] < 0) {
        ...
        let d = t.map(n[c + 1] + o, -1),
          p = d - i,
          { index: u, offset: m } = r.content.findIndex(h),
          g = r.maybeChild(u);
        if (g && m == h && m + g.nodeSize == p) {
          let k = l[c + 2].mapInner(t, g, f + 1, n[c] + o + 1, s);
          k != P
            ? ((l[c] = h), (l[c + 1] = p), (l[c + 2] = k))
            : ((l[c + 1] = -2), (a = !0));
        } else a = !0;
      }
    if (a) {
  ...
  function dc(n, e, t, r, i, o, s) {
    function l(a, c) {
      for (let f = 0; f < a.local.length; f++) {
        let h = a.local[f].map(r, i, c);
        h ? t.push(h) : s.onRemove && s.onRemove(a.local[f].spec);
      }
  ...
  function dn(n, e, t, r) {
    ...
    e.forEach((l, a) => {
      ...
      if (c) {
        ...
        f != P && i.push(a, a + l.nodeSize, f);
      }
    });
    let s = $o(o ? jo(n) : n, -t).sort(We);
    for (let l = 0; l < s.length; l++)
        ...
        for (let i = t + 1; i < e.length; i++) {
          ...
          if (o.from == r.from) {
            o.to != r.to &&
              ...
              oo(e, i + 1, o.copy(r.to, o.to)));
            continue;
          } else {
            o.from < r.to &&
              (e == n && (e = n.slice()),
              (e[t] = r.copy(r.from, o.from)),
              oo(e, i, r.copy(o.from, r.to)));
            break;
          }
        }
    }
  ...
  function er(n) {
    ...
    return (
      ...
      n.cursorWrapper && e.push(q.create(n.state.doc, [n.cursorWrapper.deco])),
      hn.from(e)
    );
  }
  var uc = {
    ...
    xr = class {
      ...
      start() {
        this.observer &&
          ...
          this.observer.observe(this.view.dom, uc)),
          this.onCharData &&
      ...
      onSelectionChange() {
        if (Xi(this.view)) {
          ...
          if (W && Oe <= 11 && !this.view.state.selection.empty) {
            let e = this.view.domSelectionRange();
            if (
              e.focusNode &&
              qe(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)
            )
      ...
      ignoreSelectionChange(e) {
        ...
        let t = new Set(),
          r;
        for (let o = e.focusNode; o; o = Ot(o)) t.add(o);
        for (let o = e.anchorNode; o; o = Ot(o))
          if (t.has(o)) {
            r = o;
            break;
          }
      ...
      flush() {
        ...
        pn(r) &&
        (c = Mr(e)) &&
        c.eq(S.near(e.state.doc.resolve(0), 1))
          ? ((e.input.lastFocus = 0),
            ge(e),
            this.currentSelection.set(r),
            e.scrollToSelection())
          : (o > -1 || i) &&
            (o > -1 && (e.docView.markDirty(o, s), mc(e)),
            this.handleDOMChange(o, s, l, a),
            e.docView && e.docView.dirty
              ? e.updateState(e.state)
              : this.currentSelection.eq(r) || ge(e),
            this.currentSelection.set(r));
      }
      registerMutation(e, t) {
        ...
        if (
          ...
          return null;
        if (e.type == "childList") {
          for (let f = 0; f < e.addedNodes.length; f++) t.push(e.addedNodes[f]);
          if (
            r.contentDOM &&
            r.contentDOM != r.dom &&
          ...
          let i = e.previousSibling,
            o = e.nextSibling;
          if (W && Oe <= 11 && e.addedNodes.length)
          ...
          let s = i && i.parentNode == e.target ? I(i) + 1 : 0,
            l = r.localPosFromDOM(e.target, s, -1),
            a =
              o && o.parentNode == e.target ? I(o) : e.target.childNodes.length,
  ...
  function ao(n, e) {
    ...
    return (
      qe(s.node, s.offset, i, o) && ([t, r, i, o] = [i, o, t, r]),
  ...
  function yc(n, e, t) {
    ...
    if (
      (f &&
        n.dom.contains(f.nodeType == 1 ? f : f.parentNode) &&
        ((c = [{ node: f, offset: a.anchorOffset }]),
        pn(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
    ...
    if (c && c[0].pos != null) {
      let g = c[0].pos,
        k = c[1] && c[1].pos;
      k == null && (k = g), (u = { anchor: g + s, head: k + s });
    }
  ...
  function bc(n) {
    ...
    if (n.nodeName == "BR" && n.parentNode) {
      if (F && /^(ul|ol)$/i.test(n.parentNode.nodeName)) {
        let t = document.createElement("div");
        return t.appendChild(document.createElement("li")), { skip: t };
      } else if (
        n.parentNode.lastChild == n ||
        (F && /^(tr|table)$/i.test(n.parentNode.nodeName))
      )
        return { ignore: !0 };
  ...
  function xc(n, e, t, r, i) {
    ...
    if (((n.input.compositionPendingChanges = 0), e < 0)) {
      ...
      if (be && !n.state.selection.eq(be)) {
        if (
          ...
          n.someProp("handleKeyDown", (Bs) => Bs(n, Be(13, "Enter")))
        )
          return;
        let Pt = n.state.tr.setSelection(be);
        M == "pointer"
          ? Pt.setMeta("pointer", !0)
          : M == "key" && Pt.scrollIntoView(),
          o && Pt.setMeta("composition", o),
          n.dispatch(Pt);
      }
      return;
    }
    ...
    n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime
      ? ((d = n.state.selection.to), (p = "end"))
      : ((d = n.state.selection.from), (p = "start")),
      (n.input.lastKeyCode = null);
    let u = Cc(h.content, c.doc.content, c.from, d, p);
    if (
      ((tt && n.input.lastIOSEnter > Date.now() - 225) || Y) &&
      i.some((M) => M.nodeType == 1 && !kc.test(M.nodeName)) &&
      (!u || u.endA >= u.endB) &&
      n.someProp("handleKeyDown", (M) => M(n, Be(13, "Enter")))
    ) {
      n.input.lastIOSEnter = 0;
      return;
    }
    ...
    n.input.domChangeCount++,
      n.state.selection.from < n.state.selection.to &&
        u.start == u.endB &&
        n.state.selection instanceof w &&
        ...
        n.state.selection.from >= c.from
          ...
          : u.endA < n.state.selection.to &&
            ...
            ((u.endB += n.state.selection.to - u.endA),
            (u.endA = n.state.selection.to))),
      W &&
        Oe <= 11 &&
        u.endB == u.start + 1 &&
    ...
    if (
      ((tt &&
        ...
        (!N || i.some((M) => M.nodeName == "DIV" || M.nodeName == "P"))) ||
        (!N &&
          m.pos < c.doc.content.size &&
          !m.sameParent(g) &&
          (ee = S.findFrom(c.doc.resolve(m.pos + 1), 1, !0)) &&
          ee.head == g.pos)) &&
      n.someProp("handleKeyDown", (M) => M(n, Be(13, "Enter")))
    ) {
      n.input.lastIOSEnter = 0;
    ...
    if (
      ...
      Mc(f, u.start, u.endA, m, g) &&
      n.someProp("handleKeyDown", (M) => M(n, Be(8, "Backspace")))
    ) {
      Y && B && n.domObserver.suppressSelectionUpdates();
      return;
    }
    B && Y && u.endB == u.start && (n.input.lastAndroidDelete = Date.now()),
      Y &&
        !N &&
        m.start() != g.start() &&
        g.parentOffset == 0 &&
    ...
    if (N) {
      if (m.pos == g.pos)
        W &&
          ...
          setTimeout(() => ge(n), 20)),
          (C = n.state.tr.delete(te, U)),
          (H = f.resolve(u.start).marksAcross(f.resolve(u.endA)));
      else if (
        u.endA == u.endB &&
        (ne = Sc(
          m.parent.content.cut(m.parentOffset, g.parentOffset),
          k.parent.content.cut(k.parentOffset, u.endA - k.start()),
        ))
      )
        (C = n.state.tr),
          ne.type == "add"
            ? C.addMark(te, U, ne.mark)
            : C.removeMark(te, U, ne.mark);
      else if (
    ...
    if (
      (C ||
        (C = n.state.tr.replace(
          te,
          U,
          c.doc.slice(u.start - c.from, u.endB - c.from),
        )),
      c.sel)
    ) {
      ...
      M &&
        !(
          (B &&
            ...
            (M.head == te || M.head == C.mapping.map(U) - 1)) ||
          (W && M.empty && M.head == te)
        ) &&
        C.setSelection(M);
    }
    H && C.ensureMarks(H),
      o && C.setMeta("composition", o),
      n.dispatch(C.scrollIntoView());
  }
  function co(n, e, t) {
    return Math.max(t.anchor, t.head) > e.content.size
      ? null
      : Cr(n, e.resolve(t.anchor), e.resolve(t.head));
  }
  function Sc(n, e) {
    ...
    if (y.from(c).eq(n)) return { mark: l, type: s };
  }
  function Mc(n, e, t, r, i) {
    if (t - e <= i.pos - r.pos || tr(r, !0, !1) < i.pos) return !1;
    let o = n.resolve(e);
    if (!r.parent.isTextblock) {
      let l = o.nodeAfter;
    ...
    if (o.parentOffset < o.parent.content.size || !o.parent.isTextblock)
      return !1;
    let s = n.resolve(tr(o, !0, !0));
    return !s.parent.isTextblock || s.pos > t || tr(s, !0, !1) < t
      ? !1
  ...
  function Cc(n, e, t, r, i) {
    ...
    if (s < o && n.size < e.size) {
      let a = r <= o && r >= s ? o - r : 0;
      (o -= a),
        o && o < e.size && fo(e.textBetween(o - 1, o + 1)) && (o += a ? 1 : -1),
        (l = o + (l - s)),
        (s = o);
    } else if (l < o) {
      let a = r <= o && r >= l ? o - r : 0;
      (o -= a),
        o && o < n.size && fo(n.textBetween(o - 1, o + 1)) && (o += a ? 1 : -1),
        (s = o + (s - l)),
        (l = o);
    }
  ...
  var un = class {
    constructor(e, t) {
      (this._root = null),
        ...
        uo(this),
        (this.nodeViews = mo(this)),
        (this.docView = Hi(this.state.doc, ho(this), er(this), this.dom, this)),
        (this.domObserver = new xr(this, (r, i, o, s) => xc(this, r, i, o, s))),
    ...
    update(e) {
      ...
      let t = this._props;
      (this._props = e),
        e.plugins && (e.plugins.forEach(go), (this.directPlugins = e.plugins)),
    ...
    updateStateInner(e, t) {
      ...
      let i = this.state,
        o = !1,
        s = !1;
      e.storedMarks && this.composing && (Wo(this), (s = !0)), (this.state = e);
      ...
      if (
        ...
        let p = mo(this);
        wc(p, this.nodeViews) && ((this.nodeViews = p), (o = !0));
      }
      (l || t.handleDOMEvents != this._props.handleDOMEvents) && gr(this),
        (this.editable = po(this)),
        uo(this);
      let a = er(this),
        c = ho(this),
        f =
          i.plugins != e.plugins && !i.doc.eq(e.doc)
            ...
            ? "to selection"
            : "preserve",
        h = o || !this.docView.matchesNode(e.doc, c, a);
      ...
      if (s) {
        ...
        !(
          ...
          ? ge(this, p)
          : (Do(this, e.selection), this.domObserver.setCurSelection()),
          this.domObserver.start();
      }
    ...
    updateDraggedNode(e, t) {
      ...
      this.dragging = new cn(
        e.slice,
        e.move,
        i < 0 ? void 0 : x.create(this.state.doc, i),
      );
    }
    someProp(e, t) {
    ...
    destroy() {
      this.docView &&
        ...
        this.destroyPluginViews(),
        this.mounted
          ? (this.docView.update(this.state.doc, [], er(this), this),
    ...
    domSelectionRange() {
      ...
      return (
        (F &&
          ...
          sa(this.dom.ownerDocument) == this.dom &&
          gc(this, e)) ||
        e
      );
    }
  ...
  function uo(n) {
    if (n.markCursor) {
      ...
      (e.className = "ProseMirror-separator"),
        ...
        (n.cursorWrapper = {
          dom: e,
          deco: ae.widget(n.state.selection.head, e, {
            raw: !0,
            marks: n.markCursor,
          }),
        });
  ...
  var z = class n extends S {
    constructor(e) {
      super(e, e);
    }
    map(e, t) {
      let r = e.resolve(t.map(this.head));
      return n.valid(r) ? new n(r) : S.near(r);
    }
    content() {
      return b.empty;
    }
  ...
  var Dr = class n {
    ...
    resolve(e) {
      ...
      return z.valid(t) ? new z(t) : S.near(t);
    }
  };
  function Nc(n) {
  ...
  function _o() {
    return new J({
      props: {
        ...
        handleClick: Ec,
        handleKeyDown: Dc,
        handleDOMEvents: { beforeinput: Ac },
      },
    });
  }
  var Dc = Xn({
  ...
  function gn(n, e) {
    let t = n == "vert" ? (e > 0 ? "down" : "up") : e > 0 ? "right" : "left";
  ...
  function Ec(n, e, t) {
    ...
    return i && i.inside > -1 && x.isSelectable(n.state.doc.nodeAt(i.inside))
      ? !1
  ...
  function Ac(n, e) {
    ...
    return o.setSelection(w.near(o.doc.resolve(t.pos + 1))), n.dispatch(o), !1;
  }
  function Ic(n) {
    ...
    return (
      ...
      q.create(n.doc, [ae.widget(n.selection.head, e, { key: "gapcursor" })])
    );
  }
  var yn = 200,
    R = function () {};
  R.prototype.append = function (e) {
    return e.length
      ? ((e = R.from(e)),
        (!this.length && e) ||
          (e.length < yn && this.leafAppend(e)) ||
          (this.length < yn && e.leafPrepend(this)) ||
          this.appendInner(e))
      : this;
  };
    ...
    He = class n {
      ...
      popEvent(e, t) {
        ...
        return (
          this.items.forEach(
            (h, d) => {
              if (!h.step) {
                i || ((i = this.remapping(r, d + 1)), (o = i.maps.length)),
                  o--,
                  f.push(h);
                return;
              }
              if (i) {
                f.push(new ce(h.map));
                let p = h.step.map(i.slice(o)),
                  u;
                p &&
                  s.maybeStep(p).doc &&
                  ((u = s.mapping.maps[s.mapping.maps.length - 1]),
                  c.push(new ce(u, void 0, void 0, c.length + f.length))),
                  o--,
                  u && i.appendMap(u, o);
              ...
              if (h.selection)
                return (
                  ...
                  (a = new n(
                    this.items.slice(0, r).append(f.reverse().concat(c)),
                    this.eventCount - 1,
                  )),
                  !1
                );
      ...
      addTransform(e, t, r, i) {
        ...
        for (let f = 0; f < e.steps.length; f++) {
          let h = e.steps[f].invert(e.docs[f]),
            d = new ce(e.mapping.maps[f], h, t),
            p;
          (p = a && a.merge(d)) &&
            ((d = p), f ? o.pop() : (l = l.slice(0, l.length - 1))),
            o.push(d),
            t && (s++, (t = void 0)),
            i || (a = d);
        }
        let c = s - r.depth;
        return c > zc && ((l = Pc(l, c)), (s -= c)), new n(l.append(o), s);
      }
      remapping(e, t) {
        let r = new ut();
        return (
      ...
      addMaps(e) {
        return this.eventCount == 0
          ? this
          : new n(this.items.append(e.map((t) => new ce(t))), this.eventCount);
      }
      rebased(e, t) {
        ...
        this.items.forEach((d) => {
          ...
          if (d.step) {
            let m = e.steps[p].invert(e.docs[p]),
              g = d.selection && d.selection.map(o.slice(a + 1, p));
      ...
      compress(e = this.items.length) {
        ...
        return (
            ...
            (s, l) => {
              if (l >= e) i.push(s), s.selection && o++;
                ...
                if ((r--, c && t.appendMap(c, r), a)) {
                  ...
                  f && o++;
                  let h = new ce(c.invert(), a, f),
                    d,
                    p = i.length - 1;
                  (d = i.length && i[p].merge(h)) ? (i[p] = d) : i.push(h);
                }
              } else s.map && r--;
            },
            this.items.length,
          ...
          new n(Er.from(i.reverse()), o)
        );
      }
    };
  He.empty = new He(Er.empty, 0);
  function Pc(n, e) {
    let t;
    return (
      n.forEach((r, i) => {
  ...
  var ce = class n {
      ...
      merge(e) {
        if (this.step && e.step && !e.selection) {
          ...
          if (t) return new n(t.getMap().invert(), t, this.selection);
        }
      }
    },
    fe = class {
  ...
  function Bc(n, e, t, r) {
    ...
    t.getMeta(Lc) && (n = new fe(n.done, n.undone, null, 0, -1));
    let s = t.getMeta("appendedTransaction");
    if (t.steps.length == 0) return n;
    if (s && s.getMeta($e))
      return s.getMeta($e).redo
        ? new fe(
            n.done.addTransform(t, void 0, r, bn(e)),
            n.undone,
            Go(t.mapping.maps[t.steps.length - 1]),
            n.prevTime,
            n.prevComposition,
          )
        : new fe(
            n.done,
            n.undone.addTransform(t, void 0, r, bn(e)),
            null,
            n.prevTime,
            n.prevComposition,
          );
  ...
  function Vc(n, e, t) {
    ...
    let s = o.selection.resolve(o.transform.doc),
      ...
      a = new fe(t ? l : o.remaining, t ? o.remaining : l, null, 0, -1);
    return o.transform
      .setSelection(s)
      .setMeta($e, { redo: t, historyState: a });
  }
  var Ir = !1,
    Yo = null;
  function bn(n) {
  ...
  function Xo(n = {}) {
    return (
      ...
      new J({
        ...
        state: {
          init() {
            return new fe(He.empty, He.empty, null, 0, -1);
          },
          apply(e, t, r) {
            return Bc(t, r, e, n);
          },
        ...
        props: {
          handleDOMEvents: {
            beforeinput(e, t) {
              let r = t.inputType,
                i = r == "historyUndo" ? At : r == "historyRedo" ? rt : null;
  ...
  var Jc = ["p", 0],
    ...
    ye = {
      ...
      image: {
        ...
        toDOM(n) {
          let { src: e, alt: t, title: r } = n.attrs;
          return ["img", { src: e, alt: t, title: r }];
        },
      },
      hard_break: {
        inline: !0,
  ...
  var Uc = ["ol", 0],
    ...
    Xc = {
      ...
      toDOM(n) {
        return n.attrs.order == 1 ? Uc : ["ol", { start: n.attrs.order }, 0];
      },
    },
    Qc = {
      parseDOM: [{ tag: "ul" }],
  ...
  function Qo(n, e, t) {
    return n.append({
      ordered_list: Rr(Xc, { content: "list_item+", group: t }),
      bullet_list: Rr(Qc, { content: "list_item+", group: t }),
      list_item: Rr(Zc, { content: e }),
    });
  }
  function it(n, e = null) {
    return function (t, r) {
      ...
      if (
        ...
        (a = new Ie(f, f, s.depth)),
          s.endIndex < s.parent.childCount &&
            (s = new Ie(i, t.doc.resolve(o.end(s.depth)), s.depth)),
          (l = !0);
      }
      let c = Ut(a, n, e, s);
      return c ? (r && r(ef(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
    };
  }
  function ef(n, e, t, r, i) {
    ...
    for (let f = e.startIndex, h = e.endIndex, d = !0; f < h; f++, d = !1)
      !d && xe(n.doc, a, l) && (n.split(a, l), (a += 2 * l)),
        (a += c.child(f).nodeSize);
    return n;
  }
  function Zo(n, e) {
    return function (t, r) {
      ...
      if (
        ...
        if (r) {
          ...
          m.doc.nodesBetween(u, m.doc.content.size, (k, N) => {
            ...
            g > -1 && m.setSelection(S.near(m.doc.resolve(g))),
            r(m.scrollIntoView());
        }
        return !0;
      }
      let a = o.pos == i.end() ? l.contentMatchAt(0).defaultType : null,
        ...
        f = a ? [e ? { type: n, attrs: e } : null, { type: a }] : void 0;
      return xe(c.doc, i.pos, 2, f)
        ? (r && r(c.split(i.pos, 2, f).scrollIntoView()), !0)
        : !1;
    };
  }
  function es(n) {
    ...
    o < s &&
      (i.step(
        new E(
          ...
          o,
          s,
          new b(y.from(t.create(null, r.parent.copy())), 1, 0),
          1,
          !0,
        ),
      ),
      (r = new Ie(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth)));
    let l = Ue(r);
    if (l == null) return !1;
    i.lift(r, l);
  ...
  function nf(n, e, t) {
    let r = n.tr,
      i = t.parent;
    for (let p = t.end, u = t.endIndex - 1, m = t.startIndex; u > m; u--)
      (p -= i.child(u).nodeSize), r.delete(p - 1, p + 1);
    ...
    return function (e, t) {
      ...
      if (t) {
        let c = a.lastChild && a.lastChild.type == l.type,
          f = y.from(c ? n.create() : null),
          h = new b(
            y.from(n.create(null, y.from(l.type.create(null, f)))),
            c ? 3 : 1,
            0,
          ),
          d = o.start,
          p = o.end;
        t(
          e.tr.step(new E(d - (c ? 3 : 1), p, d, p, h, 1, !0)).scrollIntoView(),
        );
      }
      return !0;
    };
  ...
  var Te = class {
    constructor(e, t, r = {}) {
      (this.match = e),
        (this.match = e),
        (this.handler = typeof t == "string" ? rf(t) : t),
  ...
  function Pr(n, e, t = {}) {
    ...
    for (; l < n.parent.childCount && sf(n.parent.child(l).marks, e, t); )
  ...
  var Q = (n, e = null) => {
    ...
    if (e)
      for (let [r, i] of Object.entries(e))
        /^data-|^aria-|^role/.test(r) ? t.setAttribute(r, i) : (t[r] = i);
    return t;
  };
  function Mn(n, e) {
  ...
  var ys = (n, e, t) => {
      let r = ie.fromSchema(n),
        i = function () {
          let s = Q("article");
          return (
            s.appendChild(r.serializeFragment(e.state.doc.content)), s.innerHTML
          );
        };
      return ms(() => {
        let s = i();
    ...
    bs = (n) => {
      let { $from: e, $to: t } = n,
        ...
        o = e.nodeAfter,
        s = t.nodeBefore,
        l = o && o.isText ? /^\s*/.exec(o.text)[0].length : 0,
        a = s && s.isText ? /\s*$/.exec(s.text)[0].length : 0;
      return r + l < i && ((r += l), (i -= a)), { from: r, to: i };
    };
  var Vf = (n) =>
      new Promise((e) => {
        let t = document.createElement("div");
  ...
  `),
        ...
        let r = t.querySelector("dialog"),
          i = t.querySelector("form");
        (i.href.value = n.href || ""),
          (i.title.value = n.title || ""),
          r
            ...
            .addEventListener("click", (o) => {
              o.preventDefault(),
                i.reportValidity() &&
                  ...
                  e(
                    i.href.value
                      ? { href: i.href.value, title: i.title.value }
                      : null,
                  ));
            }),
          r.showModal();
    ...
    st = (n, e) => {
      let { $from: t, empty: r } = n.selection,
        i = n.schema.marks.link;
      if (r && !i.isInSet(t.marks())) return !1;
      if (e) {
        let o = t.marks().find((s) => s.type === i);
        Vf((o == null ? void 0 : o.attrs) || {}).then((s) => {
          if (s) {
            let l;
            if (r)
              (l = Pr(t, i)),
                e(
                  n.tr
                    .removeMark(l.from, l.to, i)
                    .addMark(l.from, l.to, i.create(s)),
                );
            else {
              let { from: a, to: c } = bs(n.selection);
    ...
    ks = (n, e) => {
      let t = n.schema.marks.link,
        { $from: r, from: i, to: o } = n.selection,
        s = Pr(r, t);
      return s && s.from <= i && s.to >= o
        ? (e && e(n.tr.removeMark(s.from, s.to, t)), !0)
        : !1;
    },
    Lf = (n) =>
      new Promise((e) => {
  ...
  `),
        ...
        (i.html.value = n),
          ...
          t
            ...
            .addEventListener("click", (o) => {
              o.preventDefault(),
                i.reportValidity() && (t.remove(), e(i.html.value));
            }),
          r.showModal();
      }),
    xs = (n, e) => (
    ...
    Ss = (n, e) => (
      e &&
        e(n.tr.replaceSelectionWith(n.schema.nodes.horizontal_rule.create())),
      !0
    );
  var Ms =
      typeof navigator != "undefined"
  ...
  function Os(n) {
    ...
    if (
      ...
      r("Backspace", ns),
      Ms || r("Mod-y", rt),
      (t = n.nodes.hard_break))
    ) {
      let i = t,
        o = xt(
          jn,
          (s, l) => (
            l && l(s.tr.replaceSelectionWith(i.create()).scrollIntoView()), !0
          ),
        );
      r("Mod-Enter", o), r("Shift-Enter", o), Ms && r("Ctrl-Enter", o);
    }
    return (
      (t = n.nodes.bullet_list) && r("Shift-Ctrl-8", it(t)),
      (t = n.nodes.ordered_list) && r("Shift-Ctrl-9", it(t)),
      (t = n.nodes.blockquote) && r("Ctrl->", en(t)),
      (t = n.nodes.list_item) &&
        (r("Enter", Zo(t)), r("Mod-[", es(t)), r("Mod-]", ts(t))),
      e
    );
  }
  function ws(n) {
    let e = {},
      ...
      r = Cs(e);
    return (
      (t = n.marks.strong) && (r("Mod-b", G(t)), r("Mod-B", G(t))),
      (t = n.marks.em) && (r("Mod-i", G(t)), r("Mod-I", G(t))),
      (t = n.marks.underline) &&
        (r("Mod-Shift-u", G(t)), r("Mod-Shift-U", G(t))),
      (t = n.marks.strikethrough) &&
        (r("Mod-Shift-s", G(t)), r("Mod-Shift-S", G(t))),
      (t = n.marks.link) && (r("Mod-k", st), r("Mod-K", st)),
      e
    );
  }
  function Ns(n) {
  ...
  function Ts(n, e) {
    let { from: t, $from: r, to: i, empty: o } = n.selection;
    return o
  ...
  function Jf(n) {
    ...
    return (
      e.append(
        ...
        Q("span", { className: "level", textContent: `${n}` }),
      ),
      e
    );
  }
  ...
  function Ds(n) {
    ...
    let e = (t) => ({
      command: _n(n.nodes.heading, { level: t }),
      dom: Jf(t),
      active(r) {
  ...
  function As(n) {
    let e = (t, r, i) =>
      t ? { command: G(t), dom: Z(r, i), active: (o) => Ts(o, t) } : null;
    return [
      e(n.marks.strong, "format_bold", "bold"),
      e(n.marks.em, "format_italic", "italic"),
      e(n.marks.underline, "format_underline", "underline"),
      e(n.marks.strikethrough, "format_strikethrough", "strikethrough"),
      e(n.marks.sub, "subscript", "subscript"),
      e(n.marks.sup, "superscript", "superscript"),
    ].filter(Boolean);
  }
  function Is(n) {
    return n.marks.link
      ? [
          { command: st, dom: Z("insert_link", "insert link"), active: st },
          {
            command: ks,
  ...
  function vs() {
    return [{ command: xs, dom: Z("code", "edit HTML"), active: () => !1 }];
  }
  var Br = class {
    constructor(e, t) {
      (this.items = e.flatMap((r) => r)),
        (this.editorView = t),
        (this.dom = Q("div", { className: "prose-menubar" })),
        e
          .filter((r) => r.length)
          .forEach((r) => {
            let i = Q("div", { className: "prose-menubar__group" });
            this.dom.append(i), r.forEach(({ dom: o }) => i.append(o));
          }),
        this.update(),
        this.dom.addEventListener("mousedown", (r) => {
          r.preventDefault(),
            t.focus(),
            this.items.forEach(({ command: i, dom: o }) => {
              o.contains(r.target) && i(t.state, t.dispatch, t);
            });
        });
    }
    update() {
      this.items.forEach(({ command: e, dom: t, active: r }) => {
        let i = e(this.editorView.state, null, this.editorView);
        t.classList.toggle("disabled", !i),
          t.classList.toggle("active", r(this.editorView.state) || !1);
      });
    }
    destroy() {
      this.dom.remove();
  ...
  var Wf = ["u", 0],
    ...
    Hf = (n, e = null) => {
      ...
      let t = ["doc", "paragraph", "text", ...e],
        ...
        i = {};
      return (
        n.spec.nodes.forEach((o, s) => {
          t.includes(o) && (r[o] = s);
        }),
        n.spec.marks.forEach((o, s) => {
          t.includes(o) && (i[o] = s);
        }),
        new ke({ nodes: r, marks: i })
      );
    };
  function zs(n, e) {
    let t = {
        nodes: {
          doc: ye.doc,
          paragraph: ye.paragraph,
          heading: ye.heading,
          blockquote: ye.blockquote,
          horizontal_rule: ye.horizontal_rule,
          text: ye.text,
          hard_break: ye.hard_break,
        },
        marks: {
          link: It.link,
          strong: It.strong,
    ...
    let i = Cn(Cn({}, Os(r)), ws(r)),
      ...
      s = Q("div", { className: "prose-editor" });
    n.before(s);
    let l = new un(s, {
        state: Zt.create({ doc: Mn(r, n.value), plugins: o }),
        dispatchTransaction: (c) => {
          l.updateState(l.state.apply(c)), a();
        },
      }),
      a = ys(r, l, n);
    return () => {
